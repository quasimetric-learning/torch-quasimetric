...
# define dg(i) (*df+2.0e0*(double)(i))
  static const double abstol = 1.0e-300;
...
//    times the sum (or the sum is less than 1.0e-300).  EPS is
...
# define qxmon(zx,zy,zz) (int)((zx) <= (zy) && (zy) <= (zz))
  ...
  int i99999;
  unsigned long qbdd,qcond,qdum1,qdum2,qincr,qlim;
  unsigned long qup;
...
double eval_pol ( const double a[], const int *n, const double *x )
...
double fifdmax1 ( const double a, const double b )
...
double fifdmin1 ( const double a, const double b )
...
double fifdsign ( const double mag, const double sign )
...
inline long fifidint ( const double a )
...
long fifmod ( const long a, const long b )
