...
/*
 * From
 * https://github.com/scipy/scipy/blob/5f4c4d802e5a56708d86909af6e5685cd95e6e66/scipy/special/cephes/polevl.h
 */
...
static inline
scalar_t polevl(const scalar_t x, const scalar_t coef[], const size_t N)
{
    scalar_t ans;
    size_t i;
    const scalar_t *p;
...
template<typename scalar_t>
static inline
scalar_t p1evl(scalar_t x, const scalar_t coef[], const size_t N)
{
    scalar_t ans;
    const scalar_t *p;
    size_t i;
...
template<typename scalar_t>
static inline
scalar_t ratevl(scalar_t x, const scalar_t num[],   const size_t M,
                            const scalar_t denom[], const size_t N)
{
    size_t i;
    int dir;
